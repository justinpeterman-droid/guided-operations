...
| Migrated product code | Partial protected incident/report/history, Policy Expert, account/admin controls, plus protected assigned-shift Count Sheet load/save/reopen; no feature is accepted for release |
