...
| Area              | State                                                                                                                                                                                                                                                                                                                                                    |
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GitHub repository | Private. On 2026-09-01, Web quality, Authenticated browser quality, and Recovery rehearsal passed on exact `main` commit `49812ec4`; Database quality exposed a test-role assertion defect and stale generated types, both corrected in follow-up pull request #24. See [post-merge qualification](docs/quality/2026-09-01-post-merge-qualification.md). |
...
3. **The database CI rerun still needs to turn green.** Web quality,
   ...
   commit `49812ec4` on 2026-09-01. Database quality first exposed a pgTAP
   role-restoration defect; after that correction passed pgTAP on pull request
   #24, the next step exposed generated types missing two already-migrated
   incident-read RPCs. Both repository defects are corrected in the follow-up;
   pass the full workflow there and rerun it on the resulting exact `main`
   commit. See
