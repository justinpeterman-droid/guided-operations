...
| Retention and legal hold        | Archived operational heads receive a database-derived 730-day review date; private target-validated holds override eligibility and placement/release are audited without exposing a cleanup path.                                                          | Protected step-up admin workflow, complete records schedule, Storage/backup reconciliation, controlled deletion, hosted rehearsal, and owner approval.    |
