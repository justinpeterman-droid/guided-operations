...
| Live hobby         | Vercel Production environment on an eligible plan    | Separate live Supabase project                                               | Fictional operational data plus approved corpus; real operational data remains blocked | Explicit owner promotion                                                |
