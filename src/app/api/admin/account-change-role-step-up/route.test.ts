...
describe("POST /api/admin/account-change-role-step-up", () => {
  beforeEach(() => vi.clearAllMocks());

  it("issues a role-change-only proof after the current admin, origin, and CSRF checks", async () => {
    mockEnvironment();
    ...
    const response = await POST(
      new Request(`${origin}/api/admin/account-change-role-step-up`, {
        method: "POST",
