...
describe("POST /api/admin/legal-hold-step-up", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it.each([
    ["place", "retention.place_legal_hold"],
    ["release", "retention.release_legal_hold"],
  ] as const)("binds %s approval to %s", async (action, purpose) => {
    const response = await POST(
      new Request(`${origin}/api/admin/legal-hold-step-up`, {
        method: "POST",
